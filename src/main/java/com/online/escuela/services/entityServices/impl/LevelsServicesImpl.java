...
import com.online.escuela.services.entityServices.LevelsServices;

@Service
public class LevelsServicesImpl implements LevelsServices{
    ...
    @Override
    public Optional<LevelsDTO> findById(Long id) {
        // TODO Auto-generated method stub
